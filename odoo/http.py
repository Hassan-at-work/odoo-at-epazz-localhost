...
class WebRequest(object):
    ...
    def _call_function(self, *args, **kwargs):
        ...
        if self.endpoint.routing['type'] != self._request_type:
            ...
            _logger.info(msg+"ON LINE 326", *params)
    ...
    * the handler method's result is returned as JSON-RPC ``result`` and
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            _logger.info('%s: %s TESTING', self.httprequest.path, msg)
...
class OpenERPSession(sessions.Session):
    ...
    def authenticate(self, db, login=None, password=None):
        ...
        print("#HTTP AT LINE 1032 checking BASE LOCATION \n",request.httprequest.url_root.rstrip('/'),"\n\n\n")
