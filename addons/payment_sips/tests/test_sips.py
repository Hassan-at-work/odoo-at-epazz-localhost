    ...
    def test_feedback_processing(self):
        ...
        sips_post_data = {
            'Data': 'captureDay=0|captureMode=AUTHOR_CAPTURE|currencyCode=840|'
                    ...
                    'customerIpAddress=http://crm-stg.boxesos.com|returnContext={"return_url": '
        ...
        sips_post_data = {
            'Data': 'captureDay=0|captureMode=AUTHOR_CAPTURE|currencyCode=840|'
                    ...
                    'keyVersion=1|amount=31400|customerIpAddress=http://crm-stg.boxesos.com|returnContext={"return_url": '
                    '"/payment/process", "reference": '
