...
class Routing(Home):
    ...
    @http.route('/website/translations/<string:unique>', type='http', auth="public", cors="*", website=True)
...
class SessionWebsite(Session):
    ...
    @http.route('/web/session/logout', type='http', auth="none", website=True, cors="*", multilang=False, sitemap=False)
